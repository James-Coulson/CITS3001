...
evolution(SmartBlueAgent, params=['score_edu_redweights', 'score_edu_edges', 'score_edu_unc', 'score_con_dist', 'score_con_weight'], param_bounds={'score_edu_redweights': [-1, 1], 'score_edu_edges': [-1, 1], 'score_edu_unc': [-1, 1], 'score_con_dist': [-1, 1], 'score_con_weight': [-1, 1]}, plot=False, verbose=True, agent_is_red = False)